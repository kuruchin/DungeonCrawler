...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    #region Tooltip
    [Tooltip("Populate with the weapon UI gameobject")]
    #endregion Tooltip
    [SerializeField] private GameObject weaponUIGameObject;
    ...
    {
        // Disable UI if no weapon
        var weaponDetails = weapon?.weaponDetails;
    ...
    {
        //weaponImage.sprite = weaponDetails == null ? null : weaponDetails.weaponSprite;
