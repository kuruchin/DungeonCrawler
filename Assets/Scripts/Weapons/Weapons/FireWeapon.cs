...
public class FireWeapon : MonoBehaviour
{
    ...
    {
        // Check if no current weapon
        var currentWeapon = activeWeapon.GetCurrentWeapon();
    ...
    private void ResetCoolDownTimer()
    {
        ...
        if (currentWeapon == null)
            return;
        // Reset cooldown timer
        fireRateCoolDownTimer = currentWeapon.weaponDetails.weaponFireRate;
    }
    ...
    private void ResetPrechargeTimer()
    {
        ...
        firePreChargeTimer = currentWeapon.weaponDetails.weaponPrechargeTime;
    }
